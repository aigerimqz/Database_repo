...
--- 2 ---
--- already created all tables from lab3.sql
...
--- 10 ---
select department as code, count(*) as count_employees from employees group by department;


--- 11 ---
select department as code, count(*) as count_employees from employees
group by department
having count(*) > 2;
...
--- 14 ---
select e.name from employees e where e.city = 'Almaty'
union
select c.name from customers c where c.city = 'ALmaty';
